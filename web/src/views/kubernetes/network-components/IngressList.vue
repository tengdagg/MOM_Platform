  ...
  <div class="ingress-list">
    <div class="search-bar">
      ...
      <div class="search-bar-right">
        <el-button v-if="!kubernetesStore.isReadOnly" class="black-button" @click="handleCreate">创建 Ingress</el-button>
          ...
          <template #default="{ row }">
            <div class="action-buttons">
              ...
              <el-tooltip content="编辑" placement="top">
                <el-button link class="action-btn" :disabled="kubernetesStore.isReadOnly" @click="handleEdit(row)">
