  ...
  <div class="configmap-list">
    ...
    <div class="search-bar">
      ...
      <div class="search-bar-right">
        <el-button v-if="!kubernetesStore.isReadOnly" type="primary" class="black-button" @click="handleCreateYAML">
          <el-icon style="margin-right: 4px;"><Document /></el-icon>
          YAML创建
        </el-button>

        <el-button v-if="!kubernetesStore.isReadOnly" type="primary" class="black-button" @click="handleCreateForm">
          ...
          <template #default="{ row }">
            <div class="action-buttons">
              ...
              <el-tooltip content="编辑" placement="top">
                <el-button link class="action-btn" :disabled="kubernetesStore.isReadOnly" @click="handleEditForm(row)">
    ...
    <el-dialog v-model="yamlDialogVisible" :title="yamlDialogTitle" width="900px" class="yaml-dialog">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="handleSaveYAML" :loading="saving" :disabled="kubernetesStore.isReadOnly" class="black-button">保存</el-button>
        </div>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="formDialogVisible" :title="formDialogTitle" width="1200px" class="form-dialog">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="handleSaveForm" :loading="saving" :disabled="kubernetesStore.isReadOnly" class="black-button">{{ isEditMode ? '保存' : '创建' }}</el-button>
        </div>
      </template>
    </el-dialog>
  </div>
