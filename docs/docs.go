...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/rbac.SysLDAPConfig"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/rbac.MenuSortItem"
                            }
                        }
                    }
                ],
        ...
        "/api/v1/menus/tree": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "是否返回所有菜单（包括隐藏的），值为 true 时返回全部",
                        "name": "all",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/asset.NetworkDeviceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/plugins/kubernetes/helm/clusters/{clusterId}/releases": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.InstallReleaseRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/plugins/kubernetes/helm/clusters/{clusterId}/releases/{namespace}/{name}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.UpgradeReleaseRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/plugins/kubernetes/helm/repos": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.HelmRepo"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/plugins/kubernetes/helm/repos/{id}": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/helm/repos/{repoId}/charts": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/helm/repos/{repoId}/charts/{chartName}/versions": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/crds": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/crds/{name}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/crds/{name}/yaml": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/custom": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/custom/yaml": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/custom/{namespace}/{name}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/plugins/kubernetes/resources/custom/{namespace}/{name}/yaml": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/terminal-sessions/cleanup": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/terminal-sessions/retention": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/plugins/kubernetes/clusters/{id}/certs": {
            "get": {
        ...
        "/plugins/kubernetes/resources/ingressclasses": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/plugins/monitor/domains/{id}/history": {
            "get": {
    ...
    "definitions": {
        "asset.AssetGroup": {
            ...
            "properties": {
                ...
                "children": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/asset.AssetGroup"
                    }
                },
                "code": {
                    "type": "string"
                ...
                "deviceCount": {
                    "description": "网络设备数量（不存储在数据库）",
                    "type": "integer"
                },
                "hostCount": {
                    "description": "主机数量（不存储在数据库）",
                    "type": "integer"
                },
                "id": {
                    "type": "integer"
        ...
        "asset.NetworkDevice": {
            ...
            "properties": {
                ...
                "credential": {
                    "$ref": "#/definitions/asset.Credential"
                },
                "credentialId": {
                    "type": "integer"
                },
        ...
        "rbac.AssetPermissionCreateReqWithPermissions": {
            ...
            "properties": {
                ...
                "assetType": {
                    "description": "host 或 network_device，默认 host",
                    "type": "string"
                },
                "hostIds": {
                    "description": "空数组表示整个分组，非空表示指定主机/设备",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "rbac.SysDepartment": {
            ...
            "properties": {
                "children": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/rbac.SysDepartment"
                    }
                },
                "code": {
                    "type": "string"
        ...
        "service.InstallReleaseRequest": {
            ...
            "properties": {
                ...
                "values": {
                    "description": "YAML format values",
                    "type": "string"
                },
                "version": {
                    "type": "string"
        ...
        "service.UpgradeReleaseRequest": {
            "type": "object",
            "properties": {
                "values": {
                    "description": "YAML 格式的 values",
                    "type": "string"
                }
            }
        }
